...
\begin{frame}
    ...
    \begin{block}{Challenges with Current Testing Methods}
        \begin{itemize}
            \item Current testing methods are time-consuming and labor-intensive
            \item Manual testing is prone to more human error
            \item Lack of standardized equipment for multiple devices
            \item Difficulty in rapid validation of warranty claims
        \end{itemize}
    \end{block}
    \begin{block}{Need for Improvement}
        \begin{itemize}
            \item BST implementation in Daimler's new platform intensifies urgency
...
\begin{frame}
  ...
  \vspace{-.2025cm}
  \includegraphics[height=0.85\paperheight]{assets/diagrams/budget.png}
\end{frame}
